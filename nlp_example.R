...
# Description: This script applies a pre-trained set of models to a small example dataset of free-text antibiotic indications.
#    These have been system which have been manually labelled as belonging to one or more categories (e.g. a prescription for a chest or intra-abdominal infection).
#    The texts are pre-processed to produces a Document-Term-Matrix. 
#    Pre-trained Xgboost models are applied to the dataset to predict whether the free text indicationbelongs to a given category and the discrimination of the models is calculated.
...
d_new <- read_excel("nlp_antimicrobial_indications/nlp_sampledata.xlsx")

############################################################
#read in the models
############################################################
all_models <- readRDS("nlp_antimicrobial_indications/freetext_nlp_models.rds")
...
# In this sample dataset, class 'genit' performs poorly.
